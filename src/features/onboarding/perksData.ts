...
const perkList: Perk[] = [
  ...
  },
  {
    ...
    effects: { statBoosts: { reputation: 5 }, incomeMultiplier: 1.0 },
  ...
  },
  {
    id: 'trust_fund',
    title: 'Trust Fund',
    description: 'Start with +$50,000 and +5 reputation.',
    requirement: 'Accumulate $100,000 in net worth.',
    effects: { statBoosts: { money: 50000, reputation: 5 } },
  ...
  },
  {
    id: 'landlord',
    title: 'Landlord',
    description: '+10% passive income from properties.',
  ...
  },
  {
    id: 'star_quality',
    title: 'Star Quality',
    description: 'Begin with +20 reputation.',
    requirement: 'Reach the highest level in the celebrity career.',
    effects: { statBoosts: { reputation: 20 } },
