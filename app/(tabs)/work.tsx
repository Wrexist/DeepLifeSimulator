...
export default function WorkScreen() {
  ...
  const canPerformJob = (job: StreetJob) => {
    if (gameState.jailWeeks > 0) return false;
    ...
    >
      <View style={styles.jobHeader}>
        ...
        <View style={styles.workButtonContainer}>
          <TouchableOpacity onPress={() => handleStreetJob(job.id)} disabled={!canPerformJob(job)}>
            ...
            >
              <Text style={[styles.workButtonText, !canPerformJob(job) && styles.disabledButtonText]}>Work</Text>
            </LinearGradient>
          </TouchableOpacity>
          {workFeedback[job.id] && (
      ...
      <View style={styles.jobStats}>
        <View style={styles.statItem}>
          ...
          <Text style={[styles.statText, settings.darkMode && styles.statTextDark]}>-{job.energyCost} Energy</Text>
        </View>
        <View style={styles.statItem}>
          <TrendingUp size={16} color="#10B981" />
          <Text style={[styles.statText, settings.darkMode && styles.statTextDark]}>
            ${Math.floor(job.basePayment * (1 + (job.rank - 1) * 0.3))} avg
          </Text>
        </View>
      </View>
      ...
      {job.requirements && (
        <View style={styles.requirements}>
          <Text style={[styles.requirementsTitle, settings.darkMode && styles.requirementsTitleDark]}>Requirements:</Text>
      ...
      {job.darkWebRequirements && (
        <View style={styles.requirements}>
          <Text style={[styles.requirementsTitle, settings.darkMode && styles.requirementsTitleDark]}>Onion Gear:</Text>
          {job.darkWebRequirements.map((req: string) => {
            const item = gameState.darkWebItems.find(i => i.id === req);
            const owned = item?.owned || false;
            return (
              <Text
      ...
      <View style={styles.progressSection}>
        <View style={styles.progressInfo}>
          <Text style={[styles.progressLabel, settings.darkMode && styles.progressLabelDark]}>Progress to Rank {job.rank + 1}</Text>
          <Text style={[styles.progressPercent, settings.darkMode && styles.progressPercentDark]}>{job.progress}%</Text>
        </View>
  ...
  return (
    <LinearGradient
      colors={settings.darkMode ? ['#1E3A8A', '#1F2937'] : ['#FFFFFF', '#FFFFFF']}
    ...
    >
      ...
      <View style={[styles.tabContainer, settings.darkMode && styles.tabContainerDark]}>
        ...
        >
          <Text style={[styles.tabText, activeTab === 'street' && styles.activeTabText, settings.darkMode && styles.tabTextDark]}>
            Street Jobs
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.tabText, activeTab === 'career' && styles.activeTabText, settings.darkMode && styles.tabTextDark]}> 
            Careers
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.tabText, activeTab === 'hobby' && styles.activeTabText, settings.darkMode && styles.tabTextDark]}>
            Hobbies
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
              ...
              >
                <View style={styles.jobHeader}>
                  ...
                  {gameState.currentJob === career.id ? (
                    <TouchableOpacity
                      ...
                      onPress={quitJob}
                    >
                      <Text style={[styles.workButtonText, styles.quitButtonText]}>Quit</Text>
                    </TouchableOpacity>
                  ) : (
                    <TouchableOpacity
                      style={[
                      ...
                      disabled={career.applied || !canApplyForCareer(career)}
                    >
                      <Text
                        style={[
                      ...
                      >
                        {career.accepted ? 'Hired!' : career.applied ? 'Applied' : 'Apply'}
                      </Text>
                    </TouchableOpacity>
                  )}
                </View>

                <Text style={[styles.jobDescription, settings.darkMode && styles.jobDescriptionDark]}>{career.description}</Text>
                ...
                {(career.requirements.fitness || career.requirements.items || career.requirements.education) && (
                  <View style={styles.requirements}>
                    ...
                    {career.requirements.items?.map(itemId => {
                    ...
                    {career.requirements.education?.map(educationId => {
                ...
                {career.accepted && (
                  career.level === career.levels.length - 1 && career.progress === 100 ? (
                    <View style={styles.progressSection}>
                      <Text style={[styles.maxPromotionText, settings.darkMode && styles.maxPromotionTextDark]}>Max promotion reached</Text>
                    </View>
                  ) : (
                    <View style={styles.progressSection}>
                      <View style={styles.progressInfo}>
                        <Text style={[styles.progressLabel, settings.darkMode && styles.progressLabelDark]}>Progress to Promotion</Text>
                        <Text style={[styles.progressPercent, settings.darkMode && styles.progressPercentDark]}>{career.progress}%</Text>
                      </View>
                      <View style={styles.progressBar}>
            ...
            {gameState.hobbies.map(hobby => {
              ...
              return (
                ...
                <View style={styles.jobStats}>
                  <View style={styles.statItem}>
                    <Zap size={16} color="#EF4444" />
                    <Text style={[styles.statText, settings.darkMode && styles.statTextDark]}>-{hobby.energyCost} Energy</Text>
                  </View>
                  <View style={styles.statItem}>
                    <Star size={16} color="#F59E0B" />
                    <Text style={[styles.statText, settings.darkMode && styles.statTextDark]}>Lvl {hobby.skillLevel}</Text>
                  </View>
                  {hobby.id === 'music' || hobby.id === 'art' ? (
                    <View style={styles.statItem}>
                      ...
                      <Text style={[styles.statText, settings.darkMode && styles.statTextDark]}>
                        ...
                        {hobby.id === 'music'
                          ...
                          : hobby.artworks?.reduce((s, art) => s + art.weeklyIncome, 0) || 0}/week
                      </Text>
                    </View>
                  ) : (
                    <View style={styles.statItem}>
                      <Trophy size={16} color="#10B981" />
                      <Text style={[styles.statText, settings.darkMode && styles.statTextDark]}>${hobby.tournamentReward}</Text>
                    </View>
                  )}
                </View>
          ...
          <View>
            {gameState.jailWeeks > 0 ? (
              <View>
                ...
                >
                  You are currently in jail. Use your time wisely to improve your skills and potentially earn early release.
                </Text>
                
                <View style={styles.bailSection}>
                  <Text style={[styles.subheader, settings.darkMode && styles.subheaderDark]}>
                    Bail Options
                  </Text>
                  <TouchableOpacity
                    onPress={handlePayBail}
                    disabled={gameState.stats.money < bailCost}
                    style={styles.bailButtonWrapper}
                  >
                    <LinearGradient
                      colors={
                        gameState.stats.money < bailCost
                          ? ['#E5E7EB', '#E5E7EB']
                          : ['#DC2626', '#F87171']
                      }
                      start={{ x: 0, y: 0 }}
                    ...
                    >
                      <Text
                        style={[
                          styles.workButtonText,
                          gameState.stats.money < bailCost && styles.disabledButtonText,
                        ]}
                      >
                        Pay Bail ${bailCost}
                      </Text>
              ...
              <View>
                ...
                >
                  Crime skills improve your odds in illegal jobs. Each skill has its own upgrade tree.
                </Text>
                  ...
                  return (
                    ...
                    >
                      <LinearGradient
                        ...
                        style={styles.jobCard}
                      >
                        <View style={styles.skillLevelTop}>
                          <Star size={12} color="#F59E0B" />
                          <Text style={styles.rankText}>Level {skill.level}</Text>
                        </View>
                        <View style={styles.jobHeader}>
                          <View style={styles.jobInfo}>
                            <Text
                              style={[styles.jobName, settings.darkMode && styles.jobNameDark]}
                            >
                              {label}
                            </Text>
                          </View>
                        ...
                        <Text
                          style={[
                            ...
                            settings.darkMode && styles.jobDescriptionDark,
                          ]}
                        >
                          {CRIME_SKILL_DESCRIPTIONS[id as CrimeSkillId]}
                        </Text>
                        
                        {currentUpgrade && (
                          <View style={styles.currentUpgrade}>
                            <Text style={[styles.upgradeTitle, settings.darkMode && styles.upgradeTitleDark]}>
                              Current: {currentUpgrade.name}
                            </Text>
                            <Text style={[styles.upgradeEffect, settings.darkMode && styles.upgradeEffectDark]}>
                        ...
                        <View style={styles.skillTreeButton}>
                          <Text style={styles.skillTreeButtonText}>View Talent Tree</Text>
                        </View>
                      </LinearGradient>
                    </TouchableOpacity>
                  );
        ...
        <Modal visible={showSongs} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={[styles.modalContent, settings.darkMode && styles.modalContentDark]}>
              ...
              {(() => {
                const songs =
                  gameState.hobbies.find(h => h.id === 'music')?.songs || [];
                if (!songs.length)
                  return (
                    <Text
                      style={[styles.modalItem, settings.darkMode && styles.modalItemDark]}
                    >
                      No songs uploaded yet
                    </Text>
                  );
                const sorted = [...songs].sort(
                  (a, b) => b.weeklyIncome - a.weeklyIncome,
                );
                return (
                  <ScrollView
        ...
        <Modal visible={showArt} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={[styles.modalContent, settings.darkMode && styles.modalContentDark]}>
              ...
              {(() => {
                const artworks =
                  gameState.hobbies.find(h => h.id === 'art')?.artworks || [];
                if (!artworks.length)
                  return (
                    <Text
                      style={[styles.modalItem, settings.darkMode && styles.modalItemDark]}
        ...
        <Modal visible={!!showSponsors} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={[styles.modalContent, settings.darkMode && styles.modalContentDark]}>
              ...
              {(() => {
                const sponsors =
                  gameState.hobbies.find(h => h.id === showSponsors)?.sponsors || [];
                if (!sponsors.length)
                  return (
                    <Text
                      style={[styles.modalItem, settings.darkMode && styles.modalItemDark]}
