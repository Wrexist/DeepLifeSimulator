...
export default function Customize() {
  ...
  const [portraitId, setPortraitId] = useState<PortraitId>(() => isPortraitId(state.avatarId) ? state.avatarId : randomPortrait());
  ...
  const handleRandomizeFace = useCallback(() => {
    haptic.medium();
    if (artMode === 'portrait') setPortraitId(previous => randomPortrait(previous));
