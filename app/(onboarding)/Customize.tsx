...
export default function Customize() {
  ...
  // Starter faces for the chosen sex. Keep the selection valid as sex changes,
  // defaulting to the first face so the player always has an avatar.
  const avatarOptions = useMemo(() => listStarterAvatars(sex), [sex]);
  useEffect(() => {
  ...
  const selectedAvatar = useMemo(
    () => avatarOptions.find((option) => option.id === avatarId) ?? avatarOptions[0],
    [avatarOptions, avatarId]
  );
              ...
              <View style={styles.appearanceRow}>
                {selectedAvatar ? (
                  <View style={styles.avatarPreviewWrap}>
                    <Image source={selectedAvatar.source} style={styles.avatarPreview} resizeMode="cover" />
                  </View>
                ) : null}
                <Text style={styles.appearanceHint}>
                  Choose the face you&apos;ll start life with. It ages with you as the years pass.
                </Text>
              </View>
              <ScrollView
                horizontal
