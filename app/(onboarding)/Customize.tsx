...
export default function Customize() {
  ...
  const [creatorStart, setCreatorStart] = useState<'entry' | 'studio'>('entry');
          ...
          <BlurView intensity={20} style={styles.sectionBlur}>
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  haptic.medium();
                  // First visit offers the selfie route; a return visit goes
                  // straight to the editor. "Photo or manual?" is a question
                  // about how to START a face, and asking it again of someone
                  // who came back to nudge a jaw is noise in front of the door.
                  setCreatorStart(faceGenome ? 'studio' : 'entry');
                  if (!faceGenome) {
