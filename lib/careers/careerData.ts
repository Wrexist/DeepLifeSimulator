...
export const INITIAL_CAREERS: Career[] = [
    {
        ...
        levels: [
            ...
            // BALANCE: Shift Leader was $55 — below Crew Member ($60), an
            // unintended pay dip. Raised to $64 so the ladder never goes backwards.
            { name: 'Shift Leader', salary: 64 },
    ...
    },
    {
        ...
        levels: [
            ...
            // BALANCE: Maintenance Lead was $55 — below Senior Janitor ($65), an
            // unintended pay dip. Raised to $68 so the ladder never goes backwards.
            { name: 'Maintenance Lead', salary: 68 },
