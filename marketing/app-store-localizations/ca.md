...
```text
carrera,negoci,inversió,ric,magnat,tycoon,fallida,decisió,estratègia,presó,borsa,imperi,milionari
```
...
Comences als 18 anys amb les butxaques buides i un potencial il·limitat. Tria l'escenari inicial: nascut en la riquesa, sortint de la pobresa o qualsevol punt intermedi. La primera decisió sempre és la mateixa: quina carrera seguiràs?
...
Cada setmana porta noves oportunitats i reptes. Casa't. Tingues fills. Hereta diners. Afronta factures mèdiques inesperades. Perd la feina. Aconsegueix un ascens. Les teves decisions s'acumulen amb el temps.
...
Viu la teva vida. Construeix el teu llegat. Quan mors, et reencarnes amb avantatges de la vida anterior:

• Bonificacions generacionals d'ingressos i progressió d'habilitats
• Propietats i vehicles que hereta la teva propera vida
• Punts de prestigi que desbloquegen nous escenaris inicials
• Dinasties familiars al llarg de moltes partides

Cada vida compta. Cada generació construeix sobre l'anterior.

MÉS DE 80 ESDEVENIMENTS VITALS

Ascensos, emergències familiars, premis de loteria, accidents, escàndols, romanços, traïcions i molt més. Els esdeveniments tenen conseqüències reals. Aquell ensurt de salut? Et pot costar diners i temps. Aquell ascens? Ho canvia tot.

DESAT AL NÚVOL I DIVERSES RANURES

Juga diverses vides alhora. Canvia de personatge quan vulguis. Les teves partides es desen al núvol. No perdràs mai el progrés.

ASSOLIMENTS I CLASSIFICACIONS

Competeix amb jugadors de tot el món: assoleix fites de patrimoni net, construeix llegats familiars, arriba als 100 anys (o no) i fes fallida espectacularment.

EL TEU JOC. LES TEVES REGLES.
...
```text
Crea riquesa des de zero. Pren decisions difícils. Mira com tot s'ensorra.
```

## gp_full_description

```text
CONSTRUEIX LA TEVA VIDA. AFRONTA LES CONSEQÜÈNCIES.

Deep Life Simulator és un simulador de vida estratègic on l'economia funciona de debò: préstecs reals, interès compost, operacions de borsa, fallida i riquesa que passa de generació en generació. Els teus diners tenen regles reals.

COMENÇA DES DE ZERO.

Tens 18 anys i ni un euro a la butxaca. Tria el teu camí: nascut ric, sortint de la pobresa o començant de nou després de tocar fons. Tria una de les més de 20 carreres: metge, programador, esportista, emprenedor, criminal o qualsevol punt intermedi. La carrera determina els teus ingressos i les teves opcions.

GUANYA DINERS. INVERTEIX-LOS. MIRA COM CREIXEN.
...
Quan mors, la teva propera vida hereta bonificacions del teu llegat:
• Ingressos inicials més alts
• Propietats i vehicles heretats
• El prestigi desbloqueja nous escenaris
• Dinasties familiars al llarg de moltes vides

Cada vida que vius construeix un llegat.

MÉS DE 20 CARRERES

Metge • Programador • Esportista • Celebritat • Polític • Emprenedor • Hacker • Contrabandista • Espia • CEO • I més...

Cada carrera té ingressos, progressió i riscos únics. La teva tria defineix la teva estratègia de vida.

ASSOLIMENTS I CLASSIFICACIONS

Competeix amb jugadors de tot el món. Assoleix fites de patrimoni. Fes fallida amb estil.

DESAT AL NÚVOL I DIVERSES RANURES

Juga diverses vides alhora. Canvia de personatge. Les partides se sincronitzen entre dispositius. No perdràs mai el progrés.

JUST. SENSE PAY-TO-WIN.

Les compres desbloquegen avantatges però no trenquen el joc. Els anuncis són opcionals. L'economia premia les decisions intel·ligents, no la sort.

AIXÒ NO ÉS BITLIFE.

BitLife és divertit però aleatori. Deep Life Simulator simula una economia real. Les teves decisions financeres compten de debò. La fallida és una conseqüència, no un acudit.

CARACTERÍSTIQUES:
✓ Motor econòmic real (préstecs, interessos, fallida, inversions)
✓ Més de 20 carreres amb progressió única
✓ Borsa i comerç de criptomonedes
✓ Immobles i gestió de propietats
✓ Vehicles amb depreciació
✓ Sistema de relacions amb conseqüències
✓ Sistema de crim amb risc i recompensa
✓ Prestigi i riquesa generacional
✓ Més de 80 esdeveniments vitals
✓ Desat al núvol amb còpia de seguretat
✓ Diverses ranures de desat
✓ Assoliments i classificacions
