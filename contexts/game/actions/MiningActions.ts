...
import { MINER_UPGRADE_DEFINITIONS } from '@/lib/crypto/miningEarnings';
 ...
 * working against the same names and signatures.
 */
export { MINER_UPGRADE_DEFINITIONS, calculateMiningEarnings } from '@/lib/crypto/miningEarnings';
